...
public class ApptTest {
	...
	public void test02()  throws Throwable  {
		...
		assertTrue(appt.getValid());
		/* There is a bug here in the startMonth class, these should fail and they dont */
		//appt.setStartMonth(0);
		//assertFalse(appt.getValid());
		//appt.setStartMonth(13);
		//assertFalse(appt.getValid());
		// set month back to a valid number
		...
		//check to see if setTitle works
		appt.setTitle("Friends");
		assertEquals("Friends", appt.getTitle());
		appt.setTitle(null);
		assertEquals("", appt.getTitle());

		//check to see if setTitle works
		appt.setDescription("Friendly");
		assertEquals("Friendly", appt.getDescription());
	...
	public void test03()  throws Throwable  {
		...
		appt.setRecurrence(stuff, 3, 1, 4);
		assertEquals(stuff, appt.getRecurDays());
